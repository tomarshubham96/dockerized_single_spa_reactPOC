...
export default function showuser (){
  ...
  React.useEffect(() => {
    ...
    return ( 
      <>
        <Paper>
         <div style={{ display: "block", padding: 30,paddingTop:3,height:"273px " }}>
      <h4>Showing the User entered</h4>
      <TableContainer component={Paper} style={{ display: "block",overflowY:"scroll",height:"215px " }} >
        <Table
          size="small"
        >
          <TableHead>
